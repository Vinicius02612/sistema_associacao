...
class Socio(models.Model):
    nomeCompleto = models.CharField(verbose_name="Nome",max_length=50, blank=True)
    ...
    sexo = models.CharField(verbose_name="Sexo", max_length=10, blank=True,null=False)
    registro = models.CharField(verbose_name="RG", max_length=11, blank=True,null=False)
    arq_autoDeclaracao = models.FileField(verbose_name="Auto Declaração",upload_to="declaracoes",null=False)
    atividade_agr =  models.CharField(verbose_name="Mantem atividade agricola na comunidade", max_length=4,null=False, blank=True)
...
class Mensalidade(models.Model):
    ...
    descricao = models.CharField(verbose_name="Descrição", max_length=50, blank=True,null=False, default="Mensalidade")
    valor = models.FloatField(verbose_name="Valor", blank=True,null=False)
    reference_data = models.DateField(verbose_name="Mês de cobrança",blank=True,null=False)
    data_validade = models.DateField(verbose_name="Mês de Vencimento", blank=True,null=False)
