...
SECRET_KEY = 'django-insecure-e6ub%ohnrdiq601&$n)zyj*i^6o@ses1x@=w&3pwt6ulhy0wwz'
...
# Caminho de arquivos de media
MEDIA_ROOT = os.path.join(BASE_DIR, 'media/declaracoes')
MEDIA_URL =  '/media/declaracoes/'
